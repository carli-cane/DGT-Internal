...
A5_GENERAL =["Neptune","Jupiter","Earth","Uranus"]
   ...
   while ANSWER < 5:
      ...
      if subject == "Science":
         ...
         if choice != CA_SCIENCE[1]:
            ...
            if choice2 != CA_SCIENCE[1]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_SCIENCE[1])
               ANSWER += 1
            if choice2!= CA_SCIENCE[1]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_SCIENCE[2]:
            ...
            if choice2 != CA_SCIENCE[2]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_SCIENCE[2])
               ANSWER += 1
            if choice2!= CA_SCIENCE[2]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_SCIENCE[3]:
            ...
            if choice2 != CA_SCIENCE[3]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_SCIENCE[3])
               ANSWER += 1
            if choice2!= CA_SCIENCE[3]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_SCIENCE[4]:
            ...
            if choice2 != CA_SCIENCE[4]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_SCIENCE[4])
               ANSWER += 1
            if choice2!= CA_SCIENCE[4]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
      ...
      if subject == "Math":
         ...
         if choice != CA_MATH[1]:
            ...
            if choice2 != CA_MATH[1]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_MATH[1])
               ANSWER += 1
            if choice2!= CA_MATH[1]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_MATH[2]:
            ...
            if choice2 != CA_MATH[2]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_MATH[2])
               ANSWER += 1
            if choice2!= CA_MATH[2]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_MATH[3]:
            ...
            if choice2 != CA_MATH[3]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_MATH[3])
               ANSWER += 1
            if choice2!= CA_MATH[3]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_MATH[4]:
            ...
            if choice2 != CA_MATH[4]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_MATH[4])
               ANSWER += 1
            if choice2!= CA_MATH[4]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
      ...
      if subject == "History":
         ...
         if choice != CA_HISTORY[1]:
            ...
            if choice2 != CA_HISTORY[1]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_HISTORY[1])
               ANSWER += 1
            if choice2!= CA_HISTORY[1]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_HISTORY[2]:
            ...
            if choice2 != CA_HISTORY[2]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_HISTORY[2])
               ANSWER += 1
            if choice2 == CA_HISTORY[2]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_HISTORY[3]:
            ...
            if choice2 != CA_HISTORY[3]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_HISTORY[3])
               ANSWER += 1
            if choice2 == CA_HISTORY[3]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_HISTORY[4]:
            ...
            if choice2 != CA_HISTORY[4]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_HISTORY[4])
               ANSWER += 1
            if choice2 == CA_HISTORY[4]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
      ...
      if subject == "Geography":
         ...
         if choice != CA_GEO[1]:
            ...
            if choice2 != CA_GEO[1]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_GEO[1])
               ANSWER += 1
            if choice2 == CA_GEO[1]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_GEO[2]:
            ...
            if choice2 != CA_GEO[2]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_GEO[2])
               ANSWER += 1
            if choice2 == CA_GEO[2]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_GEO[4]:
            ...
            if choice2 != CA_GEO[4]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_GEO[4])
               ANSWER += 1
            if choice2 == CA_GEO[4]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
      ...
      if subject == "Riddles":
         ...
         if choice != CA_RIDDLES[1]:
            ...
            if choice2 != CA_RIDDLES[1]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_RIDDLES[1])
               ANSWER += 1
            if choice2 == CA_RIDDLES[1]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_RIDDLES[2]:
            ...
            if choice2 != CA_RIDDLES[2]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_RIDDLES[2])
               ANSWER += 1
            if choice2 == CA_RIDDLES[2]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_RIDDLES[3]:
            ...
            if choice2 != CA_RIDDLES[3]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_RIDDLES[3])
               ANSWER += 1
            if choice2 == CA_RIDDLES[3]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_RIDDLES[4]:
            ...
            if choice2 != CA_RIDDLES[4]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_RIDDLES[4])
               ANSWER += 1
            if choice2 == CA_RIDDLES[4]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
      ...
      if subject == "General":
         ...
         if choice != CA_GENERAL[1]:
            ...
            if choice2 != CA_GENERAL[1]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_GENERAL[1])
               ANSWER += 1
            if choice2 == CA_GENERAL[1]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_GENERAL[2]:
            ...
            if choice2 != CA_GENERAL[2]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_GENERAL[2])
               ANSWER += 1
            if choice2 == CA_GENERAL[2]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice != CA_GENERAL[3]:
            ...
            if choice2 != CA_GENERAL[3]:
               easygui.msgbox("Sorry that was incorrect")
               easygui.msgbox("The answer was " + CA_GENERAL[3])
               ANSWER += 1
            if choice2 == CA_GENERAL[3]:
               easygui.msgbox("That was correct!")
               ANSWER += 1
         ...
         if choice == CA_GENERAL[4]:
            ...
            SCORE +=1
   while ANSWER == 5:
      easygui.msgbox("Well done you completed the quiz! You got " + str(SCORE) + " out of 5")
